...
class ToolStackWidget(QWidget):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = None):
        ...
        self._ui.add_message_button.triggered.connect(self._on_add_new_message)
        self._ui.add_variant_button.triggered.connect(self._on_action_add_variant)
        self._ui.delete_message_button.triggered.connect(self._on_delete_message)
        self._ui.generate_bot_button.triggered.connect(self._on_generate_bot)
        self._ui.start_bot_button.triggered.connect(self._on_start_bot)
        self._ui.stop_bot_button.triggered.connect(self._on_stop_bot)
        self._ui.mark_start_message_button.triggered.connect(self._on_mark_as_start)
        self._ui.mark_error_message_button.triggered.connect(self._on_mark_as_error)
        self._ui.delete_variant_button.triggered.connect(self._on_delete_variant)
