...
from b_logic.data_objects import ButtonTypesEnum
...
if __name__ == '__main__':
    ...
    mobile_message = bot_api.create_message(bot, 'Какие телефоны предпочитаете?', ButtonTypesEnum.INLINE, 100, 130)
    bot_api.connect_variant(mobile_variant, mobile_message)

    computer_message = bot_api.create_message(bot, 'Какие компьютеры предпочитаете?', ButtonTypesEnum.REPLY, 200, 150)
    ...
    android_select_message = bot_api.create_message(
        bot, 'Выберите телефон который хотите приобрести', ButtonTypesEnum.INLINE, 200, 250)
    ...
    buy_samsung_galaxy_s22_message = bot_api.create_message(
        bot, 'Вы оформляете заказ Samsung Galaxy S22', ButtonTypesEnum.REPLY, 300, 150)
    ...
    buy_iphone_13_message = bot_api.create_message(bot, 'Вы оформляете заказ IPhone 13', ButtonTypesEnum.REPLY, 300, 300)
    bot_api.connect_variant(iphone_13_variant, buy_iphone_13_message)

    buy_iphone_14_message = bot_api.create_message(bot, 'Вы оформляете заказ IPhone 14', ButtonTypesEnum.REPLY, 300, 350)
